...
def create_table():
    ...
    c.execute("CREATE TABLE IF NOT EXISTS exercise_log (user_id INTEGER, year INTEGER, month INTEGER, week_start_day INTEGER, hours_01 INTEGER, hours_02 INTEGER, hours_03 INTEGER, hours_04 INTEGER, hours_05 INTEGER, hours_06 INTEGER, hours_07 INTEGER, target_muscle_group_01 TEXT, target_muscle_group_02 TEXT, target_muscle_group_03 TEXT, target_muscle_group_04 TEXT, target_muscle_group_05 TEXT, target_muscle_group_06 TEXT, target_muscle_group_07 TEXT)")
...
def register(username, password):
    ...
    params = (user_id, current_year, current_month, current_weekday, 0, 0, 0, 0, 0, 0, 0)
    c.execute("INSERT INTO exercise_log (user_id, year, month, week_start_day, hours_01, hours_02, hours_03, hours_04, hours_05, hours_06, hours_07) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", params)
