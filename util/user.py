...
def create_table():
    ...
    c.execute("CREATE TABLE IF NOT EXISTS food_log (user_id INTEGER, year INTEGER, month INTEGER, day, hour INTEGER, minute INTEGER, meal TEXT, amount REAL, calories INTEGER, carbs INTEGER, protein INTEGER, fat INTEGER)")
